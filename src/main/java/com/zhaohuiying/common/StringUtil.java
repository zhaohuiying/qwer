...
public class StringUtil {
	...
	*/
	public static String toHtml01(String text) {
		
		String string = text.replaceAll(System.getProperty("line.separator"), "|");
	 ...
	 * @return: boolean
	 */
	public static boolean idPhoneNumber(String src){
		if(!hasText(src))
			return false;
